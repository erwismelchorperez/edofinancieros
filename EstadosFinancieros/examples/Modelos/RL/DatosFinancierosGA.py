...
class Clasificadores:
    ...
    def PrediccionModelos(self, xtest):
        ...
        print("MLP:  ",self.ypredRL)
        #print("lstm: ",self.ypredlstm)
        #print("GRU:   ",self.ypredgru)

        self.meansquerederror = [mean_squared_error(self.ypredRL,ytest)]
        self.r2score = [r2_score(self.ypredRL,ytest)]
        self.errorabsolutomedio = [median_absolute_error(self.ypredRL,ytest)]
        ...
        for i in range(len(self.dataset)):
            ...
            if self.dataset.iloc[i]['NIVELv2'] == 'Predictor':
                ...
                for j in range(len(self.Pruebas)):
                    ...
                    elementos[j*2+contador+1] = clasifier.ypredRL[j]
...
for name in edo.DatosGraficar.keys():
    #print(name)
    edo.DatosGraficar[name].to_excel("./DatosGraficarGARL/"+name+"_"+clasificador+".xlsx")
