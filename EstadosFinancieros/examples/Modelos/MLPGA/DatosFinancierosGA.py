...
class Clasificadores:
    ...
    def EntranientoModelos(self, xtrain):
        ...
        if self.clasificador == "RL":
            ...
            joblib.dump(self.regresionlineal, 'regresionlineal.pkl') # Guardo el modelo.
        else:
            ...
            if self.clasificador == "DT":
                ...
                best_population = ga.evolve(population, X_train, y_train, X_val, y_val)
                ...
                joblib.dump(self.decisiontreemodel, 'decisiontreemodel.pkl') # Guardo el modelo.
            if self.clasificador == "RF":
                ...
                joblib.dump(self.randomforest, 'randomforest.pkl') # Guardo el modelo.
            if self.clasificador == "MLP":
                ...
                joblib.dump(self.mlpregresor, 'mlpregresor.pkl') # Guardo el modelo.
            if self.clasificador == "LSTM":
                ...
                joblib.dump(self.modellstm, 'modellstm.pkl') # Guardo el modelo.
            if self.clasificador == "GRU":
                ...
                joblib.dump(self.modelgru, 'modelgru.pkl') # Guardo el modelo.
    ...
    def PrediccionModelos(self, xtest):
        ...
        self.meansquerederror = [mean_squared_error(self.ypredMLP,ytest)]
        self.r2score = [r2_score(self.ypredMLP,ytest)]
        self.errorabsolutomedio = [median_absolute_error(self.ypredMLP,ytest)]
        ...
        #for i in range(len(self.dataset)):
            ...
            if self.dataset.iloc[i]['NIVELv2'] == 'Predictor':    
                ...
                for j in range(len(self.Pruebas)):
                    ...
                    elementos[j*2+contador+1] = clasifier.ypredMLP[j]
...
for name in edo.DatosGraficar.keys():
    #print(name)
    edo.DatosGraficar[name].to_excel("./DatosGraficarGAMLPGA/"+name+"_"+clasificador+".xlsx")
