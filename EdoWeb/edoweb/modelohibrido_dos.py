...
class Clasificadores:
    ...
    def PrediccionModelos(self, xtest):
        ...
        self.meansquerederror = [mean_squared_error(self.ypredlstm,ytest)]
        self.r2score = [r2_score(self.ypredlstm,ytest)]
        self.errorabsolutomedio = [median_absolute_error(self.ypredlstm,ytest)]

class EstadosFinancierosdos:
    ...
    def AnalizarPrediccion(self):
        ...
        #for i in range(len(self.dataset)):
            ...
            if self.dataset.iloc[i]['NIVELv2'] == 'Predictor':
                ...
                #self.DatosGraficar[cadena].to_excel("./DatosGraficarGALSTM/"+cadena+"_"+self.clasificador+".xlsx")
                ...
                for j in range(len(self.Pruebas)):
                    ...
                    elementos[j*2+contador+1] = clasifier.ypredlstm[j]
...
for name in edo.DatosGraficar.keys():
    #print(name)
    edo.DatosGraficar[name].to_excel("./DatosGraficarGALSTM/"+name+"_"+clasificador+".xlsx")
